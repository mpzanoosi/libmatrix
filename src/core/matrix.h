...
struct matrix *matrix_get_part(struct matrix *m, struct matrix **indices);

// 2d matrix manipulations

struct matrix *matrix_get_row(struct matrix *m, int row);

struct matrix *matrix_get_col(struct matrix *m, int col);

struct matrix *matrix_set_row(struct matrix *m, struct matrix *row);

struct matrix *matrix_set_col(struct matrix *m, struct matrix *col);
